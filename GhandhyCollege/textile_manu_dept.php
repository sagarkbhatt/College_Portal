...
<?php include 'navigatiomenu.php';
            ...
            <div class="info">
                ...
                <div class="content">
                    <br><br>
                    <strong><center><h1>Textile Manufacturing Department</h1></center></strong>
                    <br><br>
                    <p>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Textile Manufacturing course covers many types of subjects like Yarn manufacturing, Weaving Technology, Fabric structure, Quality in process control in spinning and weaving, Textile testing, Modern spinning and weaving Technologies, Advanced Texturing & Twisting, Technical Textile, Garment Technologies .</p>
                    <br>
                    <p>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Textile Manufacturing Students have industrial Training and Placments.</p>
                    <br>
            	</div>
                <div class="space">
                </div>
